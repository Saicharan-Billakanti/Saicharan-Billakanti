...
### B.Tech CSE (AI) · Machine Learning · Deep Learning · Computer Vision

I build full-stack systems and experiment with real-world AI — from Docker-sandboxed code judges to multi-agent RAG pipelines.

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/saicharan-b-/)
...
- 🔭 Currently building full-stack apps and AI-agent pipelines (RAG, ESG analysis, financial intelligence)
- 🧠 Focus areas: machine learning, deep learning, computer vision
- 🤝 Open to interesting opportunities in backend/full-stack and AI engineering
- 🌱 Learning: system design and distributed backend architecture
- 💬 Ask me about: Python, React/Node, Docker, FastAPI, or applied ML
